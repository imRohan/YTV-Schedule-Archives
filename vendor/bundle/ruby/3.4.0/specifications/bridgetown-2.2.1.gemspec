# -*- encoding: utf-8 -*-
# stub: bridgetown 2.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<bridgetown-builder>.freeze, ["= 2.2.1".freeze])
  s.add_runtime_dependency(%q<bridgetown-core>.freeze, ["= 2.2.1".freeze])
  s.add_runtime_dependency(%q<bridgetown-foundation>.freeze, ["= 2.2.1".freeze])
  s.add_runtime_dependency(%q<bridgetown-paginate>.freeze, ["= 2.2.1".freeze])
end
